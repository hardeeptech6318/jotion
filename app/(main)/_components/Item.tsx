...
import { ChevronDown, ChevronRight, LucideIcon, MoreHorizontal, Plus, Trash } from 
"lucide-react";
...
function Item({
onClick,label,Icon,
id,documentIcon,active,expanded,isSearch,level=0,onExpand
}:ItemProp) {
        ...
        <DropdownMenu>
          ...
          >
            ...
            <div className="text-xs text-muted-foreground p-2">
              Last edited by :{user?.fullName ===null ? user.username:user?.fullName}
            </div>
          </DropdownMenuContent>
        </DropdownMenu>
